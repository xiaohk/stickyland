    ...
    constructor(cellType, stickyCell) {
        ...
        this.headerMousedownHandler = (e) => {
            ...
            const mouseMoveHandler = (e) => {
                ...
                newX = Math.min(this.containerSize.width - nodeBBox.width, newX);
                newY = Math.max(0, newY);
                newY = Math.min(this.containerSize.height - nodeBBox.height, newY);
                // Also bound the max width and max height to avoid resize overflow
                this.node.style.maxWidth = `${this.containerSize.width - newX}px`;
                this.node.style.maxHeight = `${this.containerSize.height - newY}px`;
        ...
        this.node.style.maxWidth = `${this.containerSize.width - curLeft}px`;
        this.node.style.maxHeight = `${this.containerSize.height - curTop}px`;
        ...
        // Override the auto height if this cell is too long
        if (curTop + this.endPos.height > this.containerSize.height) {
            this.endPos.height = this.containerSize.height - curTop - 20;
...
//# sourceMappingURL=lib_index_js.ce7054423ecdc4f148d3.js.map