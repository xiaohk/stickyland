...
class FloatingWindow {
    constructor(cellType, stickyCell) {
        ...
        this.node.style.maxWidth = `${this.containerSize.width - 20}px`;
        this.node.style.maxHeight = `${this.containerSize.height - 20}px`;
...
//# sourceMappingURL=lib_index_js.4fd2f8715eee4617614b.js.map