    ...
    constructor(cellType, stickyCell) {
        ...
        this.headerMousedownHandler = (e) => {
            ...
            const mouseMoveHandler = (e) => {
                ...
                newX = Math.min(this.containerSize.width - nodeBBox.width - WINDOW_GAP, newX);
                newY = Math.max(0, newY);
                newY = Math.min(this.containerSize.height - nodeBBox.height - WINDOW_GAP, newY);
...
//# sourceMappingURL=lib_index_js.196874a15db12cbcd392.js.map